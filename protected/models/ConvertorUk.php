...
class ConvertorUk implements ConvertorInterface
{

	private $digits = array('один', 'два', 'три', 'четири', 'п\'ять', 'шість', 'сім', 'вісім', 'дев\'ять');
	private $tens = array('десять', 'двадцять', 'тридцять', 'сорок', 'п\'ятдесят', 'шістдесят', 'сімдесят', 'вісімдесят', 'дев\'яносто');
	private $teens = array('одинадцять', 'дванадцять', 'тринадцять', 'чотирнадцять', 'п\'ятнадцять', 'шістнадцять', 'сімнадцять', 'вісімнадцять', 'дев\'ятнадцять');
	private $hundreds = array('сто', 'двісті', 'триста', 'чотириста', 'п\'ятсот', 'шістсот', 'сімсот', 'вісімсот', 'дев\'ятсот');
	private $second_words = array(
		0 => array('тисяч', 'а', 'і', ''),
		1 => array('мильйон', '', 'а', 'ів'),
		2 => array('мильярд', '', 'а', 'ів')
	);
	private $for_thousands = array('одна', 'дві');
